...
const OPENING_DIALOGUE = [
    ...
    { speaker: 'SUNZERO', text: '안녕, 지율아. 나는 SUNZERO야. 너의 수호천사지.' },
    { speaker: '지율', text: '수호천사?! 우와! 날개가 있어요! 진짜 천사다!' },
    { speaker: 'SUNZERO', text: '곧 위험한 일이 생길 거야. 내가 너에게 특별한 무기를 줄게!' },
    { speaker: '지율', text: '위험한 일이요? 무슨 일인데요?' },
    { speaker: '나레이션', text: 'SUNZERO가 손을 흔들자 빛나는 검이 나타났습니다!' },
    { speaker: '지율', text: '우와! 이 반짝반짝한 검은 뭐예요?' },
    { speaker: 'SUNZERO', text: '그건 신검이야! 신비한 빛의 검이지. 이걸로 탁구공을 쳐봐!' },
    { speaker: '지율', text: '탁구공으로요? 신기하다!' },
    ...
    { speaker: 'SUNZERO', text: '내가 미리 말했지? 걱정하지 마. 그 검으로 물리칠 수 있어!' },
    ...
    { speaker: 'SUNZERO', text: '오호! 용감한 친구들이구나. 너희에게도 무기를 줄게!' },
    { speaker: '나레이션', text: 'SUNZERO가 다시 손을 흔들자 두 개의 무기가 더 나타났습니다!' },
    { speaker: '세은', text: '헐! 이 초록색 칼날은요? 엄청 크고 멋있어요!' },
    { speaker: 'SUNZERO', text: '청룡언월도야! 휘두르면 토네이도가 생긴단다. 바람처럼 빠르지!' },
    { speaker: '세은', text: '토네이도?! 우와! 완전 멋있다!' },
    { speaker: '하린', text: '와! 이 보라색 검은 너무 예뻐요! 반짝반짝 빛나요!' },
    { speaker: 'SUNZERO', text: '사인검이야! 휘두르면 번개 체인이 찌릿찌릿! 신기하지?' },
    { speaker: '하린', text: '찌릿찌릿! 완전 신기해요! 헤헤!' },
    { speaker: 'ABC 대마왕', text: '뭐?! 감히 셋이서! 내 부하 몬스터들! 아이들을 막아라!' },
    { speaker: 'SUNZERO', text: '얘들아, 탁구공을 쳐서 영어 단어 몬스터를 물리쳐! 영어도 배우고 탁구도 칠 수 있어!' },
    { speaker: '지율', text: '오! 탁구랑 영어를 같이 한다고요?' },
    { speaker: '세은', text: '완전 신나겠는걸! 우리 셋이 힘을 합치자!' },
    { speaker: '하린', text: '좋아! 대마왕을 물리치고 탁구 레슨 가자! 레쓰고!' },
    { speaker: 'SUNZERO', text: '파이팅! 너희라면 할 수 있어! 나도 지켜볼게!' }
];
