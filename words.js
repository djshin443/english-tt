...
const ENDING_DIALOGUE = [
    ...
    { speaker: '하린', text: '어? 저건... 숫자잖아! 1, 2, 3...!' },
    { speaker: '???', text: 'SUNZERO... 곧 만나요... 후훗...' },
    { speaker: '지율', text: '뭐야? 선제로? 그게 뭐야?' },
    { speaker: 'ABC 대마왕', text: '어라? 이건... 설마 수학 제국에서?!' },
    { speaker: '세은', text: '수학 제국?! 우리 다음 모험이 시작되는 건가?!' },
