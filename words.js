...
const OPENING_DIALOGUE = [
    ...
    { speaker: '지율', text: '헉! 무서워! 대마왕이다! 어떡하지?' },
    { speaker: 'ABC 대마왕', text: '너도 이제 영어만 공부해야 한다! 탁구 같은 건 금지야! 크하하!' },
    { speaker: '지율', text: '안 돼! 탁구 레슨은... 못 가는 건가...?' },
    { speaker: '나레이션', text: '그 순간! 하늘에서 금빛 빛줄기가 내려왔습니다!' },
    { speaker: '???', text: '잠깐! 아이를 괴롭히지 마!' },
    { speaker: '지율', text: '우와! 천사다! 날개가 있어!' },
    { speaker: 'SUNZERO', text: '안녕, 지율아. 나는 너의 수호천사 SUNZERO야.' },
    { speaker: '지율', text: '수호천사?! 우와! 정말 예뻐요!' },
    { speaker: 'SUNZERO', text: '걱정하지 마. 내가 너에게 특별한 무기를 줄게!' },
    ...
    { speaker: '지율', text: '어? 세은이? 하린이?' },
    { speaker: '세은', text: '우리도 왔어! 지율이 혼자 싸우게 둘 수 없어!' },
