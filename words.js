...
const OPENING_DIALOGUE = [
    ...
    { speaker: '세은', text: '헉! 갑자기 하늘이 어두워졌어!' },
    ...
    { speaker: '지율', text: '헉! 무서워! 우리 어떡해?' },
    { speaker: '세은', text: '대마왕이라니... 진짜 무섭게 생겼어!' },
    { speaker: '하린', text: '탁구 레슨은... 못 가는 건가...?' },
    { speaker: 'ABC 대마왕', text: '너희도 이제 영어만 공부해야 한다! 탁구 같은 건 금지야! 크하하!' },
    { speaker: '나레이션', text: '그 순간! 하늘에서 금빛 빛줄기가 내려왔습니다!' },
    { speaker: '???', text: '잠깐! 아이들을 괴롭히지 마!' },
    { speaker: '지율', text: '우와! 천사다! 날개가 있어!' },
    { speaker: 'SUNZERO', text: '안녕, 얘들아. 나는 너희의 수호천사 SUNZERO야.' },
    { speaker: '세은', text: '수호천사?! 우와! 정말 예뻐요!' },
    { speaker: 'SUNZERO', text: '걱정하지 마. 내가 너희에게 특별한 무기를 줄게!' },
    { speaker: '나레이션', text: 'SUNZERO가 손을 흔들자 세 개의 빛나는 무기가 나타났습니다!' },
    ...
    { speaker: 'ABC 대마왕', text: '뭐?! 감히 내 앞에서! 내 부하 몬스터들! 아이들을 막아라!' },
