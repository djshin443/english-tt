...
const OPENING_DIALOGUE = [
    ...
    { speaker: 'ABC 대마왕', text: '오호! 그럼 선물을 줘야겠다! 짠~! 마법 무기들이야!' },
    { speaker: '나레이션', text: 'ABC 대마왕이 손을 흔들자 세 개의 빛나는 무기가 나타났습니다!' },
    { speaker: '지율', text: '우와! 이 반짝반짝한 검은 뭐예요? 완전 멋있어요!' },
    { speaker: 'ABC 대마왕', text: '그건 신검이야! 신비한 빛의 검이지! 휙휙 휘두르면 알파벳을 날릴 수 있어!' },
    { speaker: '세은', text: '헐! 이 초록색 칼날은요? 엄청 크고 멋있는데?' },
    { speaker: 'ABC 대마왕', text: '오호~ 그건 청룡언월도! 휘두르면 토네이도가 빙글빙글 생긴다고!' },
    { speaker: '세은', text: '토네이도?! 우와! 바람처럼 빠르겠다!' },
    { speaker: '하린', text: '와! 이 보라색 검은 너무 예뻐요! 반짝반짝 빛나요!' },
    { speaker: 'ABC 대마왕', text: '후훗! 그건 특별한 사인검이야! 휘두르면 번개 체인이 찌릿찌릿!' },
    { speaker: '하린', text: '찌릿찌릿?! 완전 신기해요! 헤헤!' },
    { speaker: '지율', text: '근데 이걸로 뭘 하는 거예요?' },
    { speaker: 'ABC 대마왕', text: '탁구공을 쳐서 영어 단어 몬스터를 물리치는 거야! 재밌지?' },
    { speaker: '세은', text: '헐! 탁구랑 영어를 같이 한다고요? 완전 신나겠는걸!' },
    { speaker: '하린', text: '우리 셋이서 팀 플레이 하면 최고겠다! 와!' },
    { speaker: '지율', text: '좋아요! 그럼 시작해볼까요? 레쓰고!' }
];
