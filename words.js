...
const OPENING_DIALOGUE = [
    { speaker: '나레이션', text: '제니스 영어학원, 방과 후...' },
    { speaker: '지율', text: '휴~ 오늘 영어 학원 수업 끝! 이제 탁구 레슨 가야지!' },
    { speaker: '지율', text: '헤헤~ 오늘 탁구 선생님이 새로운 기술 가르쳐 준대!' },
    { speaker: '???', text: '잠깐, 지율아. 나 좀 봐줄래?' },
    { speaker: '지율', text: '어? 누구세요? 처음 보는 선생님인데?' },
    { speaker: '선제로', text: '안녕, 지율아. 나는 선제로야. 이 학원의 특별반 선생님이지.' },
    { speaker: '지율', text: '선제로 선생님? 처음 뵙는데요!' },
    { speaker: '선제로', text: '나는 특별한 아이들만 가르치는 선생님이야. 지율아, 너 탁구 좋아하지?' },
    { speaker: '지율', text: '네! 완전 좋아해요! 어떻게 아셨어요?' },
    { speaker: '선제로', text: '후훗~ 비밀이야. 그래서 특별한 선물을 준비했어!' },
    { speaker: '나레이션', text: '선제로 선생님이 손을 흔들자 반짝이는 탁구 라켓이 나타났습니다!' },
    { speaker: '지율', text: '우와! 이 반짝반짝한 라켓은 뭐예요? 진짜 예뻐요!' },
    { speaker: '선제로', text: '특별한 탁구 라켓이야! 이걸로 탁구공을 치면 신기한 일이 일어날 거야!' },
    { speaker: '지율', text: '신기한 일이요? 완전 궁금한데요!' },
    { speaker: '나레이션', text: '그때, 학원 밖에서...' },
    { speaker: '???', text: '으하하하! 콰광! (하늘이 어두워지며 검은 구름!)' },
    { speaker: '지율', text: '헉! 갑자기 하늘이 어두워졌어! 무슨 일이지?' },
    { speaker: 'ABC 대마왕', text: '으하하하! 나는 영어 제국의 ABC 대마왕이다!' },
    { speaker: 'ABC 대마왕', text: '지구를 영어 제국으로 만들러 왔다! 모두 내 부하가 되어라!' },
    { speaker: '지율', text: '헉! 무서워! 대마왕이다!' },
    { speaker: 'ABC 대마왕', text: '너희도 이제 영어만 공부해야 한다! 탁구 같은 건 금지야! 크하하!' },
    { speaker: '지율', text: '안 돼요! 탁구는... 내가 제일 좋아하는 건데...' },
    { speaker: '선제로', text: '걱정하지 마, 지율아. 그 라켓으로 물리칠 수 있어!' },
    { speaker: '지율', text: '네? 이 라켓으로요? 어떻게요?' },
    { speaker: '선제로', text: '탁구공을 쳐서 영어 단어 몬스터를 맞혀봐! 영어도 배우고 탁구도 칠 수 있어!' },
    { speaker: '세은', text: '지율아! 나도 빠질 수 없지!' },
    { speaker: '하린', text: '나도! 나도 빠질 수 없어!' },
    { speaker: '지율', text: '어? 세은이? 하린이? 학원에 아직 있었어?' },
    { speaker: '세은', text: '응! 우리도 남아서 공부하고 있었어! 지율이 혼자 싸우게 둘 수 없어!' },
    { speaker: '하린', text: '맞아! 우리도 도와줄게! 같이 하자!' },
    { speaker: '선제로', text: '오호! 용감한 친구들이구나. 너희에게도 특별한 선물을 줄게!' },
    { speaker: '나레이션', text: '선제로 선생님이 다시 손을 흔들자 두 개의 라켓이 더 나타났습니다!' },
    { speaker: '세은', text: '헐! 이 초록색 라켓은요? 엄청 크고 멋있어요!' },
    { speaker: '선제로', text: '청룡언월도 라켓이야! 휘두르면 토네이도가 생긴단다. 바람처럼 빠르지!' },
    { speaker: '세은', text: '토네이도?! 우와! 완전 멋있다!' },
    { speaker: '하린', text: '와! 이 보라색 라켓은 너무 예뻐요! 반짝반짝 빛나요!' },
    { speaker: '선제로', text: '사인검 라켓이야! 휘두르면 번개 체인이 찌릿찌릿! 신기하지?' },
    { speaker: '하린', text: '찌릿찌릿! 완전 신기해요! 헤헤!' },
    { speaker: 'ABC 대마왕', text: '뭐?! 감히 셋이서! 내 부하 몬스터들! 아이들을 막아라!' },
    { speaker: '세은', text: '완전 신나겠는걸! 우리 셋이 힘을 합치자!' },
    { speaker: '하린', text: '좋아! 대마왕을 물리치고 탁구 레슨 가자! 레쓰고!' },
    { speaker: '지율', text: '선제로 선생님! 도와주셔서 감사해요!' },
    { speaker: '선제로', text: '파이팅! 너희라면 할 수 있어! 내가 항상 지켜볼게!' }
];
...
const ENDING_DIALOGUE = [
    ...
    { speaker: '나레이션', text: '세 친구는 솔뜰 캠핑장으로 여행을 떠났습니다.' },
